...
import { PLUME_BRIDGES } from './bridges/plume'
import { ZIRCUIT_BRIDGES } from './bridges/zircuit'
import { XDC_BRIDGES } from './bridges/xdc'
import { KATANA_BRIDGES } from './bridges/katana'
...
export const DZAP_BRIDGES_CONFIG: {
  ...
  [CHAIN_IDS.ARBITRUM_SEPOLIA_TESTNET]: ARBITRUM_SEPOLIA_BRIDGES,
  [CHAIN_IDS.AURORA_MAINNET]: AURORA_MAINNET,
  [CHAIN_IDS.AVALANCHE_MAINNET]: AVALANCHE_MAINNET,
  [CHAIN_IDS.B2SQUARE_NETWORK]: B2SQUARE_NETWORK_BRIDGES,
  ...
  [CHAIN_IDS.CRONOS_ZKEVM_MAINNET]: CRONOS_ZK_EVM_BRIDGES,
  [CHAIN_IDS.ETH_MAINNET]: ETH_MAINNET,
  [CHAIN_IDS.ETH_SEPOLIA]: ETHEREUM_SEPOLIA_BRIDGES,
  ...
  [CHAIN_IDS.KATANA]: KATANA_BRIDGES,
  ...
  [CHAIN_IDS.MONAD_TESTNET]: MONAD_TESTNET_BRIDGES,
