...
export interface CrossChainFacetInterface extends utils.Interface {
  functions: {
...
export interface CrossChainFacet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CrossChainFacetInterface;
