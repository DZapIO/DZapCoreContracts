...
import type {
  IDZapDiamond,
  IDZapDiamondInterface,
} from "../../contracts/IDZapDiamond";
...
export class IDZapDiamond__factory {
  static readonly abi = _abi;
  static createInterface(): IDZapDiamondInterface {
    return new utils.Interface(_abi) as IDZapDiamondInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IDZapDiamond {
    return new Contract(address, _abi, signerOrProvider) as IDZapDiamond;
  }
}
